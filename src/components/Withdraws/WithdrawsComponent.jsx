        ...
        buttons.push(
          <span
            ...
            className={`px-3 py-1 rounded-md cursor-pointer ${
              currentPage === i ? 'bg-[#B92921] text-white' : 'text-black hover:bg-gray-200'
            }`}
          >
            {i}
          </span>
    ...
    <div className="bg-white text-black min-h-screen p-6">
      <div>
        ...
        <div className="relative rounded-2xl p-8 mb-8 overflow-hidden ">
          {/* Background Image */}
          <div className="absolute inset-0 w-full h-full z-0 pointer-events-none bg-[#B92921]">
            <img
          ...
          <div className="relative z-10">
            ...
            <button
              ...
              style={{ background: 'linear-gradient(180deg, #DD0F14 0%,#C21A1E 100%)' }}
            >
              Withdraw
            </button>
          </div>
        ...
        <div className="overflow-x-auto rounded-lg">
          <table className="min-w-full rounded-lg">
            <thead>
              <tr className="bg-[#B92921] text-white text-left">
      ...
      <div className="flex justify-end items-center mt-6 space-x-2">
        <button
          ...
          className="p-1 rounded-full text-[#B92921] border border-[#B92921] hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {/* Left Arrow Icon */}
        ...
        <button
          ...
          className="p-1 rounded-full border border-[#B92921] text-[#B92921] hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {/* Right Arrow Icon */}
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
