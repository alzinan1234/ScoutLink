...
const NotificationPage = ({ onBackClick }) => {
  ...
  const [allNotifications, setAllNotifications] =
    useState(initialNotifications); // Use state to manage notifications for deletion/read status
          ...
          <div className="flex items-center space-x-4 ml-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className={`${
                  notification.isRead ? "text-blue-600" : "text-purple-700"
                } hover:opacity-75 p-1 rounded-full transition-opacity duration-200`} // Adjusted colors for better contrast on white background
                aria-label={
    ...
    <div className="bg-white rounded-2xl text-black p-6 sm:p-6 lg:p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center space-x-4">
          ...
          {/* Text is already black from parent */}
        </div>
        <div className="flex items-center">
          ...
          <button className="bg-[#B92921] p-[5px] hover:bg-gray-300 transition-colors">
            {" "}
            {/* Changed bg to gray-200, hover to gray-300 */}
            <svg
