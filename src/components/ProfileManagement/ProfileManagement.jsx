  ...
  return (
    <>
      {showEditForm ? (
        ...
        <div className="min-h-screen bg-white text-gray-900 p-8 font-sans rounded-lg">
          {" "}
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col gap-6 mb-8">
              ...
              <div className="relative w-full max-w-[349px] h-[222px] overflow-hidden rounded-[14px]">
                ...
                />
                <div
                  className="absolute top-3 right-3 border border-gray-300 bg-gray-100 bg-opacity-75 rounded-full p-2 cursor-pointer hover:bg-opacity-90" // Adjusted border and background for light theme
                  onClick={toggleEditForm}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-gray-800" // Changed text to a darker gray
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className="absolute bottom-3 left-3 bg-gray-100 bg-opacity-75 rounded-full px-3 py-1 text-sm flex items-center space-x-1 text-gray-800">
                  {" "}
                ...
                <div className="absolute bottom-3 right-3 bg-gray-100 bg-opacity-75 rounded-full px-3 py-1 text-sm text-gray-800">
                  {" "}
                  {/* Adjusted background and text color */}
                  1.2 km away
                </div>
              ...
              <div>
                ...
                {/* Ensured heading is black */}
                <div className="flex flex-col md:flex-row md:items-start md:gap-24 text-gray-700">
                  {" "}
                  ...
                  <div className="flex flex-col gap-6 mb-6 md:mb-0">
                    <div className="flex items-center space-x-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 text-gray-600" // Changed text to gray-600
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                ...
                <ul className="list-disc list-inside text-gray-700 mt-6 space-y-2">
                  ...
                  <li>
                    NikoSafe Verified: Scan QR for Safe Entry - Certified by
                    xxxx
                  </li>
